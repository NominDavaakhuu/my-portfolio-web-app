...
useEffect(() => {
  ...
  const activeClass= "text-base block py-2 pr-4 pl-3 text-white bg-sky-500 md:bg-transparent md:text-sky-500 md:p-0 md:dark:text-sky-500";
  const inActiveClass= "text-base block py-2 pr-4 pl-3 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-sky-600 md:p-0 md:dark:hover:text-sky-600 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
  ...
  const handleSubmit = (event) => {
    ...
    return (
      <header> 
         <nav className="bg-white border-b-2 p-4 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
           <div className="flex flex-wrap items-center justify-between mx-auto">
              <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white px-8">Nomin-Erdene</span>
              </Link>
              ...
              <div id="mobile-nav" className="flex md:order-2">
                ...
                <button onClick={() => setHidden(!hidden)} type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className="md:hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none rounded-lg text-sm p-2.5 mr-1">
            ...
            <div className={`${hidden ? "hidden" : ""} justify-between items-center w-full md:flex md:w-auto md:order-1`} id="navbar-search">
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                ...
                <li>
                  <NavLink to="/portfolio" className={({isActive})=> isActive? activeClass: inActiveClass} >Portfolio</NavLink>
                </li>
              </ul>
            </div>
           </div>
